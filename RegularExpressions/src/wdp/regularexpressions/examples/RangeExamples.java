...
import static wdp.regularexpressions.model.PredefinedRE.*;
import static wdp.regularexpressions.model.PredefinedRE.SET.*;
...
public class RangeExamples {
    public static void main(String[] args) {
        ...
        String nadav = re.start().any_character_in("NADAV").then().a_character_described_as(a_whitespace_character).then().the_end();
